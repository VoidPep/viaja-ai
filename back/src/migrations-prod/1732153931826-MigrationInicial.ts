...
export class MigrationInicial1732153931826 implements MigrationInterface {
    name = 'MigrationInicial1732153931826'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "roteiro" ("id" SERIAL NOT NULL, "destino" character varying NOT NULL, "dataInicio" TIMESTAMP NOT NULL, "dataFim" TIMESTAMP NOT NULL, "custo_total_estimado" integer NOT NULL, "json" text NOT NULL, "idUsuario" integer, CONSTRAINT "PK_1af9808f773b04a73f70db8d9fa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "usuario" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "senha" character varying NOT NULL, "email" character varying NOT NULL, "administrador" boolean NOT NULL, "idPlano" integer, CONSTRAINT "PK_a56c58e5cabaa04fb2c98d2d7e2" PRIMARY KEY ("id"))`);
